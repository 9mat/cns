...
In total, 31,563,561 observations, or 93\% of the original data, survive this procedure. Of these, 24,225,499 (76.75\%) are street hail trips, 6,724,026 (21.30\%) completed bookings, 484,667 (1.54\%) cancelled bookings, and 129,369 (0.41\%) no-show bookings. Cancellations and no-shows account for, respectively, 6.60\% and 1.80\% total bookings.  An average street hail trip takes 15.77 minutes and earns the driver 12.72 SGD, while an average  booking trip takes 20.04 minutes and earns 17.53 SGD, inclusive of booking fees (Table \ref{tb:sumstat1}); these trips are about 4 minutes longer and earn 5 SGD more.
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\linewidth]{./fg/completedtripsdow.png}
...
\begin{figure}
	...
	\includegraphics[width=0.8\linewidth]{./fg/cns_pct_dow.png}
...
\begin{figure}
	{\centering
	\includegraphics[width=0.8\linewidth]{./fg/modelfree_quit.png}
...
\begin{figure}
	{\centering
	\includegraphics[width=0.8\linewidth]{./fg/modelfree_earnings.png}
	\caption{Average hourly earnings: with and without C\&NSs in the previous hour}
	\label{fg:earningsbyhour}}
