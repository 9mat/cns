...
Due to the data demanding nature of local weighted average, estimating Equation \eqref{eq:2dlwr} using only the set of bookings without immediate pickups is challenging. 
