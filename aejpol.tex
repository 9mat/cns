...
Due to the data demanding nature of local weigthed average, especially when we allow the hazard rate function to vary with both time and income level, estimating Equation \eqref{eq:2dlwr} using only the set of booki
