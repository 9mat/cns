...
Due to the data demanding nature of local weighted average, especially when we allow the hazard rate function to vary with both time and income level, estimating Equation \eqref{eq:2dlwr} using only the set of bookings without immediate pickups results in a 
