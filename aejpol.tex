	...
	\centering
	{
		...
		\begin{tabular}{lccccccc}
			...
			\toprule
			                                         ...
			                                         \cmidrule{2-8}
			                                         & \multicolumn{5}{c}{Stopping work (dummy)}                                   & \multicolumn{1}{>{\centering\arraybackslash}m{2cm}}{Stopping work at 8.5 hours (dummy)}  &    \multicolumn{1}{>{\centering\arraybackslash}m{2cm}}{Stopping work at 9.5 hours (dummy)}  &    \\
			\cmidrule(lr){2-6} \cmidrule(lr){7-7} \cmidrule(lr){6-6}                           
