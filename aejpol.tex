...
Earnings are high at the start and at the end of shift, which mostly reflect the earning pattern of the day-shift drivers during the morning peak and the afternoon peak. However, regardless of the timing in the shift, on average, driver-hours with some C\&NS see a higher earnings in the next hour than those without any C\&NS.
