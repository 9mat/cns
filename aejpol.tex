	...
	\centering
	{
		...
		\begin{tabular}{lccccc}
			...
			\toprule
			                                         ...
			                                         \cmidrule{2-6}
			                                         & \multicolumn{3}{c}{Stopping work (dummy)}                                   & \multicolumn{1}{>{\centering\arraybackslash}m{2cm}}{Stopping work at 8.5 hours (dummy)}  &    \multicolumn{1}{>{\centering\arraybackslash}m{2cm}}{Stopping work at 9.5 hours (dummy)}  &    \\
...
\begin{table}[]
    ...
    \begin{tabularx}{\textwidth}{l@{\extracolsep{\fill}}*{5}{S[table-format = 0.4, table-space-text-pre={**}, table-space-text-post={-**}]}}
			\toprule
			\toprule
			                                             &                             \multicolumn{5}{c}{Stopping work (dummy)}                              & \multicolumn{1}{c}{Stopping work at 8.5 hours (dummy)}       & \multicolumn{1}{c}{Stopping work at 9.5 hours (dummy)}       \\
			\cmidrule{2-6}                               & \multicolumn{1}{c}{(1)} & \multicolumn{1}{c}{(2)} & \multicolumn{1}{c}{(3)} & \multicolumn{1}{c}{(4)} & \multicolumn{1}{c}{(5)} & \multicolumn{1}{c}{(6)}   & \multicolumn{1}{c}{(7)} \\ \midrule
			...
			%Observations without singletons             & \num{2887665}           & \num{2845257}           & \num{2845257}           & \num{2843351}           & \num{2843351}           &  \\
			Drivers                                      & \num{31961}             & \num{31958}             & \num{31958}             & \num{31958}             & \num{31958}             & \num{20026}                   & \num{16721}                   \\
			\(R^2\)                                      & 0.3342                  & 0.3348                  & 0.3361                  & 0.3361                  & 0.3374                  & 0.454                         & 0.489                         \\ \bottomrule
			                                             &                         &                         &
    \end{tabularx}
