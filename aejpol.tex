...
\begin{table}[]
	...
	\centering
	{
		...
		\begin{tabular}{\textwidth}{lcccll}
			\toprule\toprule
			                                         & \multicolumn{5}{c}{\textit{Dependent Variable:}                                                                                             &    \\
			                                         & \multicolumn{3}{c}{Stopping work (dummy)}                                   & \multicolumn{1}{c}{Stopping work at 8.5 hours (dummy)  &  \multicolumn{1}{c}{(4)}   \multicolumn{1}{c}{Stopping work at 9.5 hours (dummy)  &    \\
