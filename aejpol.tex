	...
	\centering
	{
		...
		\begin{tabular}{lccccc}
			...
			\toprule
			                                         ...
			                                         & \multicolumn{3}{c}{Stopping work (dummy)}                                   & \multicolumn{1}{>{\centering\arraybackslash}m{2cm}}{Stopping work at 8.5 hours (dummy)}  &  \multicolumn{1}{c}{(4)}   \multicolumn{1}{p{2cm}}{Stopping work at 9.5 hours (dummy)}  &    \\
