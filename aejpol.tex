...
\begin{figure}
	...
	\begin{figurenotes}
	\small The two panels plot the summary statistics from the data aggregated by driver and hour into the shift. The solid lines plot the statistics for driver-hour with no C\&
	\end{figurenotes}
