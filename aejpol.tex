...
\begin{table}[]
    ...
    \begin{tabularx}{\textwidth}{l@{\extracolsep{\fill}}*{7}{S[table-format = 0.4, table-space-text-pre={**}, table-space-text-post={-**}]}}
			\toprule
			\toprule
			                                &                             \multicolumn{5}{c}{Stopping work (dummy)}                              & \multicolumn{1}{>{\centering\arraybackslash}m{1.5cm}}{Stopping work at 8.5 hours (dummy)}       & \multicolumn{1}{c}{Stopping work at 9.5 hours (dummy)}       \\
			\cmidrule{2-6}                               
			                                & \multicolumn{1}{>{\centering\arraybackslash}m{1.5cm}}{(1)} & \multicolumn{1}{c}{(2)} & \multicolumn{1}{c}{(3)} & \multicolumn{1}{c}{(4)} & \multicolumn{1}{c}{(5)} & \multicolumn{1}{c}{(6)}         & \multicolumn{1}{c}{(7)} 
			\\ 
			\midrule
			Cancellation (dummy)            & -0.0154\sym{***}        & -0.0167\sym{***}        & -0.0148\sym{***}        & -0.0136\sym{***}        & -0.0123\sym{***}        & -0.0277\sym{***}                 & -0.0305\sym{***}         \\
			                                & (0.0009)                & (0.0010)                & (0.0010)                & (0.0010)                & (0.0010)                & (0.0041)                       & (0.0052)                 \\
			\addlinespace
			No-show (dummy)                 & -0.0116\sym{***}        & -0.0128\sym{***}        & -0.0114\sym{***}        & -0.0131\sym{***}        & -0.0116\sym{***}        & -0.0246\sym{***}                 & -0.0310\sym{***}         \\
			                                & (0.0015)                & (0.0016)                & (0.0016)                & (0.0016)                & (0.0016)                & (0.0069)                      & (0.0083)                 \\
			\addlinespace
			Weather \& Market thickness     & {}                      & {Y}                     & {Y}                     & {Y}                     & {Y}                     &                            \\
			Break \& passenger time         & {}                      & {}                      & {Y}                     & {Y}                     & {Y}                     &                               &                               \\
			On-call time \& distance        & {}                      & {}                      & {}                      & {Y}                     & {Y}                     &                               &                               \\
		   ...
		   \midrule
			...
			Observations                    & \num{3792025}           & \num{3745117}           & \num{3745117}           & \num{3743047}           & \num{3743047}           & \num{171843}                  & \num{137647}                  \\
			Drivers                         & \num{31961}             & \num{31958}             & \num{31958}             & \num{31958}             & \num{31958}             & \num{20026}                   & \num{16721}                   \\
			\(R^2\)                         & 0.3342                  & 0.3348                  & 0.3361                  & 0.3361                  & 0.3374                  & 0.4543                         & 0.4890                         \\ 
			\bottomrule
	\end{tabularx}
