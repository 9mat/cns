...
% 	\begin{threeparttable}
        ...
        \midrule
        Cancellation (dummy)&     -0.0217&     -0.0234&     -0.0187&     -0.0199&     -0.0212&     -0.0211\\
                    &    (0.0003)&    (0.0003)&    (0.0003)&    (0.0003)&    (0.0004)&    (0.0004)\\
        \addlinespace
        No-show (dummy)&     -0.0225&     -0.0225&     -0.0185&     -0.0201&     -0.0225&     -0.0224\\
                    &    (0.0005)&    (0.0005)&    (0.0005)&    (0.0005)&    (0.0005)&    (0.0005)\\
        \addlinespace
        Driver FE   &       {Yes}&       {Yes}&       {Yes}&       {Yes}&       {Yes}&       {Yes}\\
        Date FE     &       {Yes}&       {Yes}&       {Yes}&       {Yes}&       {Yes}&       {Yes}\\
        Hour\(\times\)day-of-week FE&         {-}&       {Yes}&         {-}&         {-}&         {-}&         {-}\\
        Hour\(\times\)day-of-week\(\times\)zone FE&         {-}&         {-}&       {Yes}&       {Yes}&       {Yes}&       {Yes}\\
        Additional Controls &         {-}&         {-}&         {-}&         {-}&       {Yes}&       {Yes}\\
        Controls for cumulative hours &         {linear}&         {linear}&         {linear}&         {cubic}&       {cubic}&       {cubic}\\
        Controls for cumulative income &         &         &         &         &       &       {cubic}\\
        \midrule
        Marginal effects & & & & & &\\
        \quad Cumulative hour (at 8 hours)&      0.0228&      0.0234&      0.0236&      0.0302&      0.0305&      0.0230\\
...
% 	\begin{threeparttable}
        ...
        \toprule
            &\multicolumn{1}{c}{(1)}&\multicolumn{1}{c}{(2)}&\multicolumn{1}{c}{(3)}&\multicolumn{1}{c}{(4)}&\multicolumn{1}{c}{(5)}&\multicolumn{1}{c}{(6)}\\
            \midrule
            Cancellation (dummy)&       0.733&       0.581&       0.359&       0.337&       0.190&       0.159\\
                        &     (0.012)&     (0.011)&     (0.011)&     (0.011)&     (0.012)&     (0.012)\\
            \addlinespace
            No-show (dummy)&       0.179&       0.042&      -0.169&      -0.195&      -0.268&      -0.300\\
                        &     (0.018)&     (0.017)&     (0.017)&     (0.017)&     (0.018)&     (0.018)\\
            \addlinespace
            Driver FE   &       {Yes}&       {Yes}&       {Yes}&       {Yes}&       {Yes}&       {Yes}\\
            Date FE     &       {Yes}&       {Yes}&       {Yes}&       {Yes}&       {Yes}&       {Yes}\\
            Hour\(\times\)day-of-week FE&         {-}&       {Yes}&         {-}&         {-}&         {-}&         {-}\\
