...
\begin{abstract}
	...
	drivers work longer and earn more per hour following cancellations or no-shows, and the effects are strongest when cumulative income is close to the average shift income and insignificant when the income is too low or too high. This provides 
...
The estimates suggest that axi drivers tend to overcompensate for C\&NS,
and total income tends to be 3.4 SGD higher in shifts with some cancellations, and 70 cents higher
in shifts withou
