...
\footnote{We also observe similar recency effects of earnings onlabour supply, 
but only up to the eighth hour into the shift (see Table \ref{tb:robustquitbyhour}, Column (6)).},
and attribute such phenonmen to the drivers updating their refernce point based on recent earnings.
If the reference point is fixed for the entire shift, the timing of C\&NS should not matter,
as long as they generate 
