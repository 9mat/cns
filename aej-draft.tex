...
The dynamic nature of the C\&BS effects suggest a role for an adaptive reference point. This is similar to the results in \citet{thakral2018daily}, in which the authors find recent earnings to have stronger effects on labour than earnings in earlier in the shift\footnote{We also observe similar recency effects 
of earnings onlabour supply, but only up to the eighth hour into the shift 
(see Table \ref{tb:robustquitbyhour}, Column (6)).}. 
