...
\begin{abstract}
	...
	This paper studies the impact of booking cancellations and passenger no-shows, a negative unanticipated income shocks, on taxi drivers' labor supply and productivity. Using a novel large dataset of taxi trips and bookings in Singapore, we find that drivers work longer and earn more per hour following cancellations or no-shows. Working longer and increasing productivity are substitutable rather than complementary devices, and are chosen by taxi drivers in their own favor: More experienced drivers tend to increase productivity, and solo drivers tend to work more hours. 
\end{abstract}
