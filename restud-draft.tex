...
\paragraph{Drivers' unobserved plan} Drivers may have unobserved plans and may seek bookings with destinations that are convenient to the plans. The results in previous sections where we allow the driver fixed effects to vary with time and locations partially addresses this issues, because time and location is likely to capture a major portion of the variation in the drivers' plan. We also utilize a portion of the data in which the passengers do not specify the destination at the time of booking, and hence it is unlikely that the drivers can plan ahead of the booking. 
