...
\begin{abstract}
	...
	\citet{kHoszegi2006model} shows that workers with endogenous income targets respond differently to anticipated changes and unanticipated shocks in their earnings, and only the later generate behaviours that contradict neoclassical model of labor supply.
	We study the impact of booking cancellations and passenger no-shows, a negative unanticipated income shocks, on taxi drivers' labor supply and productivity. Using a novel large dataset of taxi trips and bookings in Singapore, we find that drivers work longer and earn more per hour following cancellations or no-shows. This provides compelling evidences for income targeting labor supply, even in the presence of endogenous reference point. Moreover, we find drivers responding more strong to more recent cancellation and no-shows, suggesting a dynamic nature of the reference point. We also find that working longer and increasing productivity are substitutable rather than complementary devices, and are chosen by taxi drivers in their own favor: More experienced drivers tend to increase productivity, and solo drivers tend to work more hours. 
\end{abstract}
