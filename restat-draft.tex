...
\begin{table}		        \hspace*{-2pt}\makebox[\linewidth][c]{%      
    ...
    \footnotesize	   
    \def\sym#1{\ifmmode^{#1}\else\(^{#1}\)\fi}
    \begin{tabularx}{\textwidth}{l@{\extracolsep{\fill}}*{7}{S[round-mode=places,round-precision=3]}} %ChaoQin
        \toprule
        \toprule
        ...
        %Observations&\num{31108566}&\num{31108566}&\num{28087962}&\num{28069852}&\num{23413398}&\num{23413398}&\num{23413398}\\
        Observations&\num[round-mode=off,round-precision=0]{31}&\num{31}&\num{28}&\num{28}&\num{23}&\num{23413398}&\num{23}\\
                Clusters    & \num{33667}& \num{33667}& \num{33667}& \num{33667}& \num{33650}& \num{33650}& \num{33650}\\
...
%	\begin{threeparttable}
	...
	\begin{tabularx}{\textwidth}{l@{\extracolsep{\fill}}*{5}{S}}
        ...
        \midrule
        Cancellation (dummy)&      0.0015&     -0.0219\sym{***}&     -0.0288\sym{***}&     -0.0166&     -0.0068\\
                    &    (0.0188)&    (0.0074)&    (0.0051)&    (0.0086)&    (0.0187)\\
        \addlinespace
        No-show (dummy)&     -0.0132&     -0.0166&     -0.0264\sym{**}&     -0.0070&      0.0542\\
