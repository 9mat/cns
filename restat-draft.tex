...
The U-shaped pattern can be observed in the first two panels in Figure \ref{fg:2dulwrnoisy}, which corresponds to the C\&NS effects on the hazard rate at 8 and 8.5 hours into the shift. This pattern is less prominent in the latter three panels, which correspond to the hazard rates at 9, 9.5, and 10 hours, for two reasons. First, the estimates are more noisy, especially at 9.5 and 10 hours, due to smaller sample size at these hours of the shift. Secondly, there seems to be a shift in the reference point  to the right after 9 hours of work, which is reasonable given that the drivers who work more than 9 hours are likely to set higher targets for themselves. 
