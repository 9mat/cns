...
% - For reference style, you will mostly work with restat.bst. This file is even more compliatedOr you can file 
...
\begin{abstract}
	...
	drivers work longer and earn more per hour following cancellations or no-shows, and the 
      effects are strongest when cumulative income is close to the average shift income and become insignificant when the income is too low or too high. This provides 
