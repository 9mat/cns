...
%		\small
        ...
        \toprule
                            ...
                            &\multicolumn{1}{>{\centering\arraybackslash}p{1.5cm}}{Break time in next hour (minutes)} &\multicolumn{1}{>{\centering\arraybackslash}p{1.5cm}}{Speed with POB in next hour (km/h)} &\multicolumn{1}{>{\centering\arraybackslash}p{1.5cm}}{Completed trips in next hour (count)} &\multicolumn{1}{>{\centering\arraybackslash}p{1.5cm}}{Distance to next job (km)} &\multicolumn{1}{>{\centering\arraybackslash}p{1.5cm}}{Time to next job (minutes)} &\multicolumn{1}{>{\centering\arraybackslash}p{1.5cm}}{Speed to next job (km/h)} &\multicolumn{1}{>{\centering\arraybackslash}p{1.5cm}}{Time with passenger in next hour (minutes)}\\
        \midrule
