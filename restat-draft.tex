...
\begin{figure}[!ht]
	...
	\includegraphics[width=0.7\textwidth]{./fg/dowplot.pdf}
	\label{fg:trips}
\end{figure}
...
The marginal benefit of spending effort in the second period is $\eta$ if $e_1+e_2+u > t$, and $$\lambda\eta &\hbox{ if } e_1+e_2+u < t\end{cases}\]
