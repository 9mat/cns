...
\paragraph{Settings, Data and Methodology} The taxi industry has been of great interest to economists due to its special work 
...
\paragraph{Main Results, Interpretation, and Economic Significance} Our analysis shows that drivers work longer and earn more per hour following 
...
%\paragraph{Interpretation}
 Our results, collectively, suggest income targeting behavior to be the explanation
...
$\Delta(u|a_1, a_2, c_1, c_2, t^*) = a_2 - c_2 + l(a_1 + a_2 + u - t^*) -  l(a_1 + u - t^*) + \epsilon_2$. Under the target $t^*+\delta$ and parameter set $(a_1+\delta, a_2, c_1, c_2)$, if the unanticipated earnings are $u$, net utility of working is 
