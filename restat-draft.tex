...
Table \ref{tb:earningsbreakdown} shows that after C\&NS taxi drivers adjust their labor and productivity along multiple margins. They reduce the break time by 15\% (0.82 minutes (s.e. 0.05) and 0.86 minutes (s.e. , increase the speed when with passenger to complete the jobs faster, and are able to finish more trips in the  hour following C\&NS. They also drive faster and spend less time and driving distance to find the next job. 
