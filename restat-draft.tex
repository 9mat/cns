...
The U shape pattern can be observed in the first two panels in Figure \ref{fg:2dulwrnoisy}, which corresponds to the C\&NS effects on the hazard at 8 and 8.5 hours into the shift. The decrease in the magnitude of the C\&NS effects when cumulative income is at the two tail are also present in 
