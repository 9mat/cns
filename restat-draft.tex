...
Table \ref{tb:earningsbreakdown} shows that after C\&NS taxi drivers adjust their labor and productivity along multiple margins. In the  hour following C\&NS, they reduce the break time by 15\% (a decrease of 0.82 minutes (s.e. 0.05) and 0.86 minutes (s.e. 0.09) from an average break time of 5.3 minutes), increase the speed when with passenger by more than 10\% to complete the jobs faster (an increase of 4 km/h (s.e. 0.19) and 4.5 km/h (s.e. 0.32) from the average speed 35 km/h), and are able to finish 6\% more trips. They also drive faster and spend less time and driving distance to find the next job. 
