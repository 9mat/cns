...
\[\min_{\beta_c, \beta_{ns}, \alpha_i, \gamma, \lambda \sum_{it} w(h_{it}-h) (Quit_{it} - \beta_c(h_{it})C_{it} + \beta_{ns}(h_{it}){NS}_{it} + \alpha_i(h_{it}) + g(h_{it}, y_{it}) + X_{it}\gamma(h_{it})\]
