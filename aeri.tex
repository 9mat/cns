...
The booking fee is a nontrivial portion of the total fare. The typical booking fee (3.3 SGD) equals 23\% of the average trip fare exclusive of the booking fee. Furthermore, there is no penalty for CNS, which makes street hail trips 
...
This not only provides further evidence that CNS are random exogenous events over time. 
and also highlights an advantage of using variation in random earnings shocks over 
