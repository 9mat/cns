...
affected by driver behavior, and hence the variation in C\&NS encounters is exogenous from the drivers' perspective.
...
out of the within-buidling driver-specific portion of C\&NS variation that is uncorrelated with date and hour. 
