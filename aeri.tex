...
The effects of CNS on extensive and intensive margins combined lead to S\$3.45 (s.e. 0.07) increase in shift income after a cancellation and S\$0.68 (s.e. 0.11) increase after a no-show (Appendix Table \re).
...
have negligible, statistically insignificant effects on either the decisions to stop or subsequent earnings (Table A4). As a result, we can rule out unobserved market conditions as an explanation for our results.
