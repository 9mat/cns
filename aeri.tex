...
We match each CNS with the nearest vacant driver who ends a trip within 3 minutes of the CNS, and assign imaginary placebo CNS to that driver. Alternatively, we also match each CNS with all the vacant drivers who end a trip within 200 m and 3 minutes of the CNS and use them as the second group of placebo subjects. Using the nearest driver is likely to produce better matches, while using all nearby drivers increases the sample size of the placebo group and the statistical power of the test. 
