...
This provides strong evidence that C\&NS are random exogenous events over time. 
highlight an additional advantage of our approach---using random earnings shocks---over the usual approach of using cumulative income, since cumulative income is highly correlated
