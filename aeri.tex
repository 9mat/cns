...
\footnote{A uniform weight with bandwidth $b$ sets $w(d) = 1$ if $|d|<b$ and $w(d) = 0$ otherwise. Another commonly used weight is the tricube weight: $w(h_{it}-h) = \left(1-(|h_{it}-h|/b)^3\right)^3$ if $|h_{it}-h|<b$, and $w(h_{it}-h) = 0$ otherwise.} 
