...
use a linear probability model instead of a logistic model because the inclusion of driver and time fixed effects renders logistic estimation computationally
