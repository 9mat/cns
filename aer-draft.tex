...
% 		\begin{tablenotes}
%         Trip fares for booking trip include booking fees; trip durations for booking trip exclude on-call time. Completed trips include both street hail trips and completed bookings.
% 		\end{tablenotes}
% % 	\end{threeparttable}
% \end{table}
...
%		\small
		...
		\begin{tablenotes}
			Each column is a separate regression. An observation is a driver-hour. All regressions control fro driver fixed effects, date fixed effects and hour of day\(\times\)day of week fixed effects. Standard errors clustered by drivers in parentheses. 
		\end{tablenotes}
%	\end{threeparttable}
\end{table}
...
%		\small
		...
		\begin{tablenotes}
			Each column is a separate regression. An observation is a trip or booking. All regressions control fro driver fixed effects, date fixed effects and hour of day\(\times\)day of week\(\times\)zone fixed effects. Standard errors clustered by drivers in parentheses. 
		\end{tablenotes}
	% \end{threeparttable}
\end{table}
