...
Labor supply theory is often framed as a dichotomy: on one hand is the neoclassical model in which workers trade off leisure time for additional labor income until wage equates the disutility of working, and on the other hand is the reference dependent preference model
